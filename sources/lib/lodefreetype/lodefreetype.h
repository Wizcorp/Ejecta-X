...
unsigned draw_stroke_font(char** image, unsigned* w, unsigned* h, void* font_info, unsigned long font_index, size_t font_size, unsigned int x, unsigned int y, const char* str);
