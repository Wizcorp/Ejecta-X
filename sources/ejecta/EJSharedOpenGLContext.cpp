...
EJSharedOpenGLContext* EJSharedOpenGLContext::sharedOpenGLContext = NULL;
...
EJSharedOpenGLContext* EJSharedOpenGLContext::instance()
{
	if( !sharedOpenGLContext ) {
		sharedOpenGLContext = new EJSharedOpenGLContext();
		sharedOpenGLContext->autorelease();
	}
